...
Please see the `sampling profiler instructions <doc_sampling_profilers>` for more information.
...
- Open [VerySleepy](https://github.com/VerySleepy/verysleepy) and select the Godot executable in the list of processes on the left:
