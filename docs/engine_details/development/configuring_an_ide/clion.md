...
[CLion](https://www.jetbrains.com/clion/) is a [JetBrains](https://www.jetbrains.com/) IDE for C++ that's free for individual, non-commercial development.
...
<img src="img/clion-preferences.png" />

- Click **Add target** and give the target a name, e.g. `Godot debug`.

<img src="img/clion-target.png" />
...
<img src="img/clion-build-run.png" />
