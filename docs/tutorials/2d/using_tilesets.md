...
Tilesheet with 64×64 tiles. Credit: <a href="https://kenney.nl/assets/abstract-platformer">Kenney</a>
...
<img src="img/using_tilesets_using_default_rectangle_collision.webp" alt="Using default rectangle collision shape by pressing `F`" />
Using default rectangle collision shape by pressing <code class="interpreted-text" role="kbd">F</code>
