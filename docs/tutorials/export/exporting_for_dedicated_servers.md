...
Choosing the <strong>Export as dedicated server</strong> export mode in the export preset
...
\# Run your server startup code here... \# \# Using this check, you can start a dedicated server by running \# a Godot binary (editor or export template) with the --headless \# command-line argument. pass

csharp

using System.Linq;

if (DisplayServer.GetName() == "headless") { // Run your server startup code here... // // Using this check, you can start a dedicated server by running // a Godot binary (editor or export template) with the --headless // command-line argument. }
...
\# Run your server startup code here... \# \# Using this check, you can start a dedicated server by running \# a Godot binary (editor or export template) with the --server \# command-line argument. pass

csharp

using System.Linq;

if (OS.GetCmdlineUserArgs().Contains("--server")) { // Run your server startup code here... // // Using this check, you can start a dedicated server by running // a Godot binary (editor or export template) with the --server // command-line argument. }
