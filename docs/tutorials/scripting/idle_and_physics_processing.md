...
public override void Process(double delta) { // Do something... }
...
public override void PhysicsProcess(double delta) { // Do something... }
...
public partial class CustomLabel : Label { private double time;

> public override void Process(double delta) { time += delta; Text = time.ToString(); // 'Text' is a built-in Label property. }
