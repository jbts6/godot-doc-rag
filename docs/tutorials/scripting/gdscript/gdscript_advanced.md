...
For more details see `_iter_init() <class_Object_private_method__iter_init>`, `_iter_next() <class_Object_private_method__iter_next>`, and `_iter_get() <class_Object_private_method__iter_get>`.
