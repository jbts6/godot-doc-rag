...
func my_level_was_completed():
get_tree().change_scene_to_file("res://levels/level2.tscn")

csharp

public void MyLevelWasCompleted() { GetTree().ChangeSceneToFile("res://levels/level2.tscn"); }
...
public void MyLevelWasCompleted() { var nextScene = (PackedScene)ResourceLoader.Load("res://levels/level2.tscn"); GetTree().ChangeSceneToPacked(nextScene); }
