...
public partial class MyNode3D : Node3D { private XRInterface xrInterface;

> public override void Ready() { xrInterface = XRServer.FindInterface("OpenXR"); if(xrInterface != null && xrInterface.IsInitialized()) { GD.Print("OpenXR initialized successfully");
>
