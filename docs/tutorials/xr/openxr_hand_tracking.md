...
> - Tracking happens in the local space of the `XROrigin3D <class_xrorigin3d>` node. This node must be a child of the XROrigin3D node in order to be correctly placed.
