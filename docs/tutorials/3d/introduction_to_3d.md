...
Godot Third Person Shooter (TPS) Demo, available on the <a href="https://github.com/godotengine/tps-demo">Github repository</a> or the <code class="interpreted-text" role="ref">Asset Library &lt;doc_project_manager_downloading_demos&gt;</code>.
...
Image by <a href="https://twitter.com/FreyaHolmer">Freya Holmér</a>
