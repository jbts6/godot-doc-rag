...
Two particle systems are affected by the same vector field attractor. <code class="interpreted-text" role="download">Click here to download the 3D texture &lt;img/particle_vector_field_16x16x16.bmp&gt;</code>.