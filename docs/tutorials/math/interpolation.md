...
public override void PhysicsProcess(double delta) { t += (float)delta \* 0.4f;

> Marker2D a = GetNode\<Marker2D\>("A"); Marker2D b = GetNode\<Marker2D\>("B"); Sprite2D sprite = GetNode\<Sprite2D\>("Sprite2D");
>
> sprite.Position = a.Position.Lerp(b.Position, t);
...
public override void PhysicsProcess(double delta) { t += (float)delta;
...
public override void PhysicsProcess(double delta) { Vector2 mousePos = GetLocalMousePosition();
...
> private const float FollowSpeed = 4.0f;
>
> public override void Process(double delta) { Vector2 mousePos = GetLocalMousePosition();
>
