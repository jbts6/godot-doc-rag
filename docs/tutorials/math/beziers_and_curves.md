...
func process(delta):
t += delta position = cubic_bezier(p0, p1, p2, p3, t)

csharp

private float t = 0.0f;

public override void Process(double delta) { t += (float)delta; Position = CubicBezier(p0, p1, p2, p3, t); }
...
public override void Process(double delta) { t += (float)delta; Position = curve.SampleBaked(t \* curve.GetBakedLength(), true); }
