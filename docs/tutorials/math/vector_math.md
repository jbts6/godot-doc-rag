...
KinematicCollision2D collision = MoveAndCollide(velocity \* (float)delta); if (collision != null) { var reflect = collision.GetRemainder().Bounce(collision.GetNormal()); velocity = velocity.Bounce(collision.GetNormal()); MoveAndCollide(reflect); }
