...
- `void (No return value.)` **set_vertices**(value: `PackedVector3Array<class_PackedVector3Array>`)
...
`bool<class_bool>` **get_avoidance_layer_value**(layer_number: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationObstacle3D_method_get_avoidance_layer_value>`
...
`RID<class_RID>` **get_navigation_map**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationObstacle3D_method_get_navigation_map>`
...
`RID<class_RID>` **get_rid**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationObstacle3D_method_get_rid>`
...
`void (No return value.)` **set_avoidance_layer_value**(layer_number: `int<class_int>`, value: `bool<class_bool>`) `🔗<class_NavigationObstacle3D_method_set_avoidance_layer_value>`
...
`void (No return value.)` **set_navigation_map**(navigation_map: `RID<class_RID>`) `🔗<class_NavigationObstacle3D_method_set_navigation_map>`
