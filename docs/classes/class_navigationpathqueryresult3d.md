...
- `void (No return value.)` **set_path**(value: `PackedVector3Array<class_PackedVector3Array>`)
...
`void (No return value.)` **reset**() `🔗<class_NavigationPathQueryResult3D_method_reset>`
