...
- `void (No return value.)` **set_allow_object_decoding**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_auth_callback**(value: `Callable<class_Callable>`)
...
- `void (No return value.)` **set_auth_timeout**(value: `float<class_float>`)
...
- `void (No return value.)` **set_max_delta_packet_size**(value: `int<class_int>`)
...
- `void (No return value.)` **set_max_sync_packet_size**(value: `int<class_int>`)
...
- `void (No return value.)` **set_server_relay_enabled**(value: `bool<class_bool>`)
...
`void (No return value.)` **clear**() `🔗<class_SceneMultiplayer_method_clear>`
...
`void (No return value.)` **disconnect_peer**(id: `int<class_int>`) `🔗<class_SceneMultiplayer_method_disconnect_peer>`
