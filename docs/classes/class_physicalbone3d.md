...
- `Ragdoll System <../tutorials/physics/ragdoll_system>`
...
- `void (No return value.)` **set_angular_damp_mode**(value: `DampMode<enum_PhysicalBone3D_DampMode>`)
...
- `void (No return value.)` **set_body_offset**(value: `Transform3D<class_Transform3D>`)
...
- `void (No return value.)` **set_joint_offset**(value: `Transform3D<class_Transform3D>`)
...
- `void (No return value.)` **set_joint_rotation**(value: `Vector3<class_Vector3>`)
...
- `void (No return value.)` **set_joint_type**(value: `JointType<enum_PhysicalBone3D_JointType>`)
...
- `void (No return value.)` **set_linear_damp_mode**(value: `DampMode<enum_PhysicalBone3D_DampMode>`)
...
`void (No return value.)` **\_integrate_forces**(state: `PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>`) `virtual (This method should typically be overridden by the user to have any effect.)` `🔗<class_PhysicalBone3D_private_method__integrate_forces>`
...
`void (No return value.)` **apply_central_impulse**(impulse: `Vector3<class_Vector3>`) `🔗<class_PhysicalBone3D_method_apply_central_impulse>`
...
`void (No return value.)` **apply_impulse**(impulse: `Vector3<class_Vector3>`, position: `Vector3<class_Vector3>` = Vector3(0, 0, 0)) `🔗<class_PhysicalBone3D_method_apply_impulse>`
...
`int<class_int>` **get_bone_id**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PhysicalBone3D_method_get_bone_id>`
