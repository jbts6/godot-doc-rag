...
- `void (No return value.)` **set_probe_data**(value: `VoxelGIData<class_VoxelGIData>`)
...
- `void (No return value.)` **set_subdiv**(value: `Subdiv<enum_VoxelGI_Subdiv>`)
...
`void (No return value.)` **bake**(from_node: `Node<class_Node>` = null, create_visual_debug: `bool<class_bool>` = false) `🔗<class_VoxelGI_method_bake>`
...
`void (No return value.)` **debug_bake**() `🔗<class_VoxelGI_method_debug_bake>`
