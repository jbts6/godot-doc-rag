...
- `void (No return value.)` **set_bounce_indirect_energy**(value: `float<class_float>`)
...
- `void (No return value.)` **set_bounces**(value: `int<class_int>`)
...
- `void (No return value.)` **set_denoiser_range**(value: `int<class_int>`)
...
- `void (No return value.)` **set_denoiser_strength**(value: `float<class_float>`)
...
- `void (No return value.)` **set_directional**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_environment_custom_color**(value: `Color<class_Color>`)
...
- `void (No return value.)` **set_environment_custom_energy**(value: `float<class_float>`)
...
- `void (No return value.)` **set_environment_custom_sky**(value: `Sky<class_Sky>`)
...
- `void (No return value.)` **set_environment_mode**(value: `EnvironmentMode<enum_LightmapGI_EnvironmentMode>`)
...
- `void (No return value.)` **set_generate_probes**(value: `GenerateProbes<enum_LightmapGI_GenerateProbes>`)
...
- `void (No return value.)` **set_light_data**(value: `LightmapGIData<class_LightmapGIData>`)
...
- `void (No return value.)` **set_max_texture_size**(value: `int<class_int>`)
...
- `void (No return value.)` **set_bake_quality**(value: `BakeQuality<enum_LightmapGI_BakeQuality>`)
...
- `void (No return value.)` **set_shadowmask_mode**(value: `ShadowmaskMode<enum_LightmapGIData_ShadowmaskMode>`)
...
- `void (No return value.)` **set_supersampling_enabled**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_supersampling_factor**(value: `float<class_float>`)
...
- `void (No return value.)` **set_texel_scale**(value: `float<class_float>`)
...
- `void (No return value.)` **set_use_denoiser**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_use_texture_for_bounces**(value: `bool<class_bool>`)
