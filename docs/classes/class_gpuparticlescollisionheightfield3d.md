...
- `void (No return value.)` **set_follow_camera_enabled**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_heightfield_mask**(value: `int<class_int>`)
...
- `void (No return value.)` **set_resolution**(value: `Resolution<enum_GPUParticlesCollisionHeightField3D_Resolution>`)
...
- `void (No return value.)` **set_update_mode**(value: `UpdateMode<enum_GPUParticlesCollisionHeightField3D_UpdateMode>`)
...
`bool<class_bool>` **get_heightfield_mask_value**(layer_number: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GPUParticlesCollisionHeightField3D_method_get_heightfield_mask_value>`
...
`void (No return value.)` **set_heightfield_mask_value**(layer_number: `int<class_int>`, value: `bool<class_bool>`) `🔗<class_GPUParticlesCollisionHeightField3D_method_set_heightfield_mask_value>`
