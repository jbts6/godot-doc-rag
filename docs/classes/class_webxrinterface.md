...
- `void (No return value.)` **set_optional_features**(value: `String<class_String>`)
...
- `void (No return value.)` **set_requested_reference_space_types**(value: `String<class_String>`)
...
- `void (No return value.)` **set_required_features**(value: `String<class_String>`)
...
- `void (No return value.)` **set_session_mode**(value: `String<class_String>`)
...
`Array<class_Array>` **get_available_display_refresh_rates**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_WebXRInterface_method_get_available_display_refresh_rates>`
...
`float<class_float>` **get_display_refresh_rate**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_WebXRInterface_method_get_display_refresh_rate>`
...
`TargetRayMode<enum_WebXRInterface_TargetRayMode>` **get_input_source_target_ray_mode**(input_source_id: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_WebXRInterface_method_get_input_source_target_ray_mode>`
...
`XRControllerTracker<class_XRControllerTracker>` **get_input_source_tracker**(input_source_id: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_WebXRInterface_method_get_input_source_tracker>`
...
`bool<class_bool>` **is_input_source_active**(input_source_id: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_WebXRInterface_method_is_input_source_active>`
...
`void (No return value.)` **is_session_supported**(session_mode: `String<class_String>`) `🔗<class_WebXRInterface_method_is_session_supported>`
...
`void (No return value.)` **set_display_refresh_rate**(refresh_rate: `float<class_float>`) `🔗<class_WebXRInterface_method_set_display_refresh_rate>`
