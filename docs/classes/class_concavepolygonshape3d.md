...
- `void (No return value.)` **set_backface_collision_enabled**(value: `bool<class_bool>`)
...
`PackedVector3Array<class_PackedVector3Array>` **get_faces**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_ConcavePolygonShape3D_method_get_faces>`
...
`void (No return value.)` **set_faces**(faces: `PackedVector3Array<class_PackedVector3Array>`) `🔗<class_ConcavePolygonShape3D_method_set_faces>`
