...
`void (No return value.)` **add_resource_format_loader**(format_loader: `ResourceFormatLoader<class_ResourceFormatLoader>`, at_front: `bool<class_bool>` = false) `🔗<class_ResourceLoader_method_add_resource_format_loader>`
...
`void (No return value.)` **remove_resource_format_loader**(format_loader: `ResourceFormatLoader<class_ResourceFormatLoader>`) `🔗<class_ResourceLoader_method_remove_resource_format_loader>`
...
`void (No return value.)` **set_abort_on_missing_resources**(abort: `bool<class_bool>`) `🔗<class_ResourceLoader_method_set_abort_on_missing_resources>`
