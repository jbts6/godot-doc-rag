...
- `void (No return value.)` **set_auto_exposure_max_sensitivity**(value: `float<class_float>`)
...
- `void (No return value.)` **set_auto_exposure_min_sensitivity**(value: `float<class_float>`)
...
- `void (No return value.)` **set_dof_blur_amount**(value: `float<class_float>`)
...
- `void (No return value.)` **set_dof_blur_far_distance**(value: `float<class_float>`)
...
- `void (No return value.)` **set_dof_blur_far_enabled**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_dof_blur_far_transition**(value: `float<class_float>`)
...
- `void (No return value.)` **set_dof_blur_near_distance**(value: `float<class_float>`)
...
- `void (No return value.)` **set_dof_blur_near_enabled**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_dof_blur_near_transition**(value: `float<class_float>`)
