...
- `void (No return value.)` **set_color_default**(value: `ColorDefault<enum_VisualShaderNodeTextureParameter_ColorDefault>`)
...
- `void (No return value.)` **set_texture_filter**(value: `TextureFilter<enum_VisualShaderNodeTextureParameter_TextureFilter>`)
...
- `void (No return value.)` **set_texture_repeat**(value: `TextureRepeat<enum_VisualShaderNodeTextureParameter_TextureRepeat>`)
...
- `void (No return value.)` **set_texture_source**(value: `TextureSource<enum_VisualShaderNodeTextureParameter_TextureSource>`)
...
- `void (No return value.)` **set_texture_type**(value: `TextureType<enum_VisualShaderNodeTextureParameter_TextureType>`)
