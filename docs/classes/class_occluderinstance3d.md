...
- `void (No return value.)` **set_bake_simplification_distance**(value: `float<class_float>`)
...
- `void (No return value.)` **set_occluder**(value: `Occluder3D<class_Occluder3D>`)
...
`bool<class_bool>` **get_bake_mask_value**(layer_number: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OccluderInstance3D_method_get_bake_mask_value>`
...
`void (No return value.)` **set_bake_mask_value**(layer_number: `int<class_int>`, value: `bool<class_bool>`) `🔗<class_OccluderInstance3D_method_set_bake_mask_value>`
