...
`void (No return value.)` **adjust_bcs**(brightness: `float<class_float>`, contrast: `float<class_float>`, saturation: `float<class_float>`) `🔗<class_Image_method_adjust_bcs>`
...
`void (No return value.)` **blend_rect**(src: `Image<class_Image>`, src_rect: `Rect2i<class_Rect2i>`, dst: `Vector2i<class_Vector2i>`) `🔗<class_Image_method_blend_rect>`
...
`void (No return value.)` **blend_rect_mask**(src: `Image<class_Image>`, mask: `Image<class_Image>`, src_rect: `Rect2i<class_Rect2i>`, dst: `Vector2i<class_Vector2i>`) `🔗<class_Image_method_blend_rect_mask>`
...
`void (No return value.)` **blit_rect**(src: `Image<class_Image>`, src_rect: `Rect2i<class_Rect2i>`, dst: `Vector2i<class_Vector2i>`) `🔗<class_Image_method_blit_rect>`
...
`void (No return value.)` **blit_rect_mask**(src: `Image<class_Image>`, mask: `Image<class_Image>`, src_rect: `Rect2i<class_Rect2i>`, dst: `Vector2i<class_Vector2i>`) `🔗<class_Image_method_blit_rect_mask>`
...
`void (No return value.)` **bump_map_to_normal_map**(bump_scale: `float<class_float>` = 1.0) `🔗<class_Image_method_bump_map_to_normal_map>`
...
`void (No return value.)` **clear_mipmaps**() `🔗<class_Image_method_clear_mipmaps>`
...
`void (No return value.)` **convert**(format: `Format<enum_Image_Format>`) `🔗<class_Image_method_convert>`
...
`void (No return value.)` **copy_from**(src: `Image<class_Image>`) `🔗<class_Image_method_copy_from>`
...
`Image<class_Image>` **create**(width: `int<class_int>`, height: `int<class_int>`, use_mipmaps: `bool<class_bool>`, format: `Format<enum_Image_Format>`) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)` `🔗<class_Image_method_create>`
...
`Image<class_Image>` **create_empty**(width: `int<class_int>`, height: `int<class_int>`, use_mipmaps: `bool<class_bool>`, format: `Format<enum_Image_Format>`) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)` `🔗<class_Image_method_create_empty>`
...
`Image<class_Image>` **create_from_data**(width: `int<class_int>`, height: `int<class_int>`, use_mipmaps: `bool<class_bool>`, format: `Format<enum_Image_Format>`, data: `PackedByteArray<class_PackedByteArray>`) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)` `🔗<class_Image_method_create_from_data>`
...
`void (No return value.)` **crop**(width: `int<class_int>`, height: `int<class_int>`) `🔗<class_Image_method_crop>`
...
`AlphaMode<enum_Image_AlphaMode>` **detect_alpha**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_detect_alpha>`
...
`UsedChannels<enum_Image_UsedChannels>` **detect_used_channels**(source: `CompressSource<enum_Image_CompressSource>` = 0) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_detect_used_channels>`
...
`void (No return value.)` **fill**(color: `Color<class_Color>`) `🔗<class_Image_method_fill>`
...
`void (No return value.)` **fill_rect**(rect: `Rect2i<class_Rect2i>`, color: `Color<class_Color>`) `🔗<class_Image_method_fill_rect>`
...
`void (No return value.)` **fix_alpha_edges**() `🔗<class_Image_method_fix_alpha_edges>`
...
`void (No return value.)` **flip_x**() `🔗<class_Image_method_flip_x>`
...
`void (No return value.)` **flip_y**() `🔗<class_Image_method_flip_y>`
...
`PackedByteArray<class_PackedByteArray>` **get_data**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_data>`
...
`int<class_int>` **get_data_size**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_data_size>`
...
`Format<enum_Image_Format>` **get_format**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_format>`
...
`int<class_int>` **get_height**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_height>`
...
`int<class_int>` **get_mipmap_count**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_mipmap_count>`
...
`int<class_int>` **get_mipmap_offset**(mipmap: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_mipmap_offset>`
...
`Color<class_Color>` **get_pixel**(x: `int<class_int>`, y: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_pixel>`
...
`Color<class_Color>` **get_pixelv**(point: `Vector2i<class_Vector2i>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_pixelv>`
...
`Image<class_Image>` **get_region**(region: `Rect2i<class_Rect2i>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_region>`
...
`Vector2i<class_Vector2i>` **get_size**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_size>`
...
`Rect2i<class_Rect2i>` **get_used_rect**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_used_rect>`
...
`int<class_int>` **get_width**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_get_width>`
...
`bool<class_bool>` **has_mipmaps**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_has_mipmaps>`
...
`bool<class_bool>` **is_compressed**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_is_compressed>`
...
`bool<class_bool>` **is_empty**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_is_empty>`
...
`bool<class_bool>` **is_invisible**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_is_invisible>`
...
`void (No return value.)` **linear_to_srgb**() `🔗<class_Image_method_linear_to_srgb>`
...
`Image<class_Image>` **load_from_file**(path: `String<class_String>`) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)` `🔗<class_Image_method_load_from_file>`
...
`void (No return value.)` **normal_map_to_xy**() `🔗<class_Image_method_normal_map_to_xy>`
...
`void (No return value.)` **premultiply_alpha**() `🔗<class_Image_method_premultiply_alpha>`
...
`void (No return value.)` **resize**(width: `int<class_int>`, height: `int<class_int>`, interpolation: `Interpolation<enum_Image_Interpolation>` = 1) `🔗<class_Image_method_resize>`
...
**Note:** If the image's format is `FORMAT_RGBA4444<class_Image_constant_FORMAT_RGBA4444>`, `FORMAT_RGB565<class_Image_constant_FORMAT_RGB565>`, or `FORMAT_RGBE9995<class_Image_constant_FORMAT_RGBE9995>`, it will be temporarily converted to either `FORMAT_RGBA8<class_Image_constant_FORMAT_RGBA8>` or `FORMAT_RGBAH<class_Image_constant_FORMAT_RGBAH>`. This can affect the quality of the resized image.

classref-item-separator

classref-method

`void (No return value.)` **resize_to_po2**(square: `bool<class_bool>` = false, interpolation: `Interpolation<enum_Image_Interpolation>` = 1) `🔗<class_Image_method_resize_to_po2>`
...
`void (No return value.)` **rotate_90**(direction: `ClockDirection<enum_@GlobalScope_ClockDirection>`) `🔗<class_Image_method_rotate_90>`
...
`void (No return value.)` **rotate_180**() `🔗<class_Image_method_rotate_180>`
...
`Error<enum_@GlobalScope_Error>` **save_dds**(path: `String<class_String>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_dds>`
...
`PackedByteArray<class_PackedByteArray>` **save_dds_to_buffer**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_dds_to_buffer>`
...
`Error<enum_@GlobalScope_Error>` **save_exr**(path: `String<class_String>`, grayscale: `bool<class_bool>` = false, color_image: `bool<class_bool>` = false, max_linear_value: `float<class_float>` = -1.0) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_exr>`

Saves the image as an EXR file to `path`. If `grayscale` is `true` and the image has only one channel, it will be saved explicitly as monochrome rather than one red channel. Set `color_image` to `true` when saving a color image, such as a screenshot. Negative values will be included when `color_image` is `false`, which may be useful for saving raw floating point data such as a lightmap that includes negative light information. Color component values in the resulting EXR file will not exceed `max_linear_value` if `max_linear_value` is not negative. This function will return `@GlobalScope.ERR_UNAVAILABLE<class_@GlobalScope_constant_ERR_UNAVAILABLE>` if Godot was compiled without the TinyEXR module.

When saving screenshots of a project that uses HDR output, use `Window.get_output_max_linear_value()<class_Window_method_get_output_max_linear_value>` for `max_linear_value`.

classref-item-separator

classref-method

`PackedByteArray<class_PackedByteArray>` **save_exr_to_buffer**(grayscale: `bool<class_bool>` = false, color_image: `bool<class_bool>` = false, max_linear_value: `float<class_float>` = -1.0) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_exr_to_buffer>`
...
`Error<enum_@GlobalScope_Error>` **save_jpg**(path: `String<class_String>`, quality: `float<class_float>` = 0.75) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_jpg>`
...
`PackedByteArray<class_PackedByteArray>` **save_jpg_to_buffer**(quality: `float<class_float>` = 0.75) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_jpg_to_buffer>`
...
`Error<enum_@GlobalScope_Error>` **save_png**(path: `String<class_String>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_png>`
...
`PackedByteArray<class_PackedByteArray>` **save_png_to_buffer**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_png_to_buffer>`
...
`Error<enum_@GlobalScope_Error>` **save_webp**(path: `String<class_String>`, lossy: `bool<class_bool>` = false, quality: `float<class_float>` = 0.75) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_webp>`
...
`PackedByteArray<class_PackedByteArray>` **save_webp_to_buffer**(lossy: `bool<class_bool>` = false, quality: `float<class_float>` = 0.75) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Image_method_save_webp_to_buffer>`
...
`void (No return value.)` **set_data**(width: `int<class_int>`, height: `int<class_int>`, use_mipmaps: `bool<class_bool>`, format: `Format<enum_Image_Format>`, data: `PackedByteArray<class_PackedByteArray>`) `🔗<class_Image_method_set_data>`
...
`void (No return value.)` **set_pixel**(x: `int<class_int>`, y: `int<class_int>`, color: `Color<class_Color>`) `🔗<class_Image_method_set_pixel>`

Sets the `Color<class_Color>` of the pixel at `(x, y)` to `color`.

gdscript

var img_width = 10 var img_height = 5 var img = Image.create(img_width, img_height, false, Image.FORMAT_RGBA8)

img.set_pixel(1, 2, Color.RED) \# Sets the color at (1, 2) to red.

csharp

int imgWidth = 10; int imgHeight = 5; var img = Image.Create(imgWidth, imgHeight, false, Image.Format.Rgba8);
...
`void (No return value.)` **set_pixelv**(point: `Vector2i<class_Vector2i>`, color: `Color<class_Color>`) `🔗<class_Image_method_set_pixelv>`
...
`void (No return value.)` **shrink_x2**() `🔗<class_Image_method_shrink_x2>`
...
`void (No return value.)` **srgb_to_linear**() `🔗<class_Image_method_srgb_to_linear>`
