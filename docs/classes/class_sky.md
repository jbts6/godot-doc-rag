...
- `void (No return value.)` **set_process_mode**(value: `ProcessMode<enum_Sky_ProcessMode>`)
...
- `void (No return value.)` **set_radiance_size**(value: `RadianceSize<enum_Sky_RadianceSize>`)
