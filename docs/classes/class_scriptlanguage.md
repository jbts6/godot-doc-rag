...
**Inherited By:** `ScriptLanguageExtension<class_ScriptLanguageExtension>`
...
`ScriptNameCasing<enum_ScriptLanguage_ScriptNameCasing>` **SCRIPT_NAME_CASING_CAMEL_CASE** = `4`
