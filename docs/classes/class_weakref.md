...
`Variant<class_Variant>` **get_ref**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_WeakRef_method_get_ref>`
