...
- `void (No return value.)` **set_clear_mode**(value: `ClearMode<enum_SubViewport_ClearMode>`)
...
- `void (No return value.)` **set_update_mode**(value: `UpdateMode<enum_SubViewport_UpdateMode>`)
...
- `void (No return value.)` **set_size_2d_override**(value: `Vector2i<class_Vector2i>`)
...
- `void (No return value.)` **set_size_2d_override_stretch**(value: `bool<class_bool>`)
...
`int<class_int>` **view_count** = `1` `🔗<class_SubViewport_property_view_count>`
