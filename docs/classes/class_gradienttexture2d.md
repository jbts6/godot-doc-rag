...
`Fill<enum_GradientTexture2D_Fill>` **FILL_CONIC** = `3`
...
- `void (No return value.)` **set_fill**(value: `Fill<enum_GradientTexture2D_Fill>`)
...
- `void (No return value.)` **set_fill_from**(value: `Vector2<class_Vector2>`)
...
- `void (No return value.)` **set_fill_to**(value: `Vector2<class_Vector2>`)
...
- `void (No return value.)` **set_repeat**(value: `Repeat<enum_GradientTexture2D_Repeat>`)
