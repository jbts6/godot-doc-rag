...
**Inherited By:** `AwaitTweener<class_AwaitTweener>`, `CallbackTweener<class_CallbackTweener>`, `IntervalTweener<class_IntervalTweener>`, `MethodTweener<class_MethodTweener>`, `PropertyTweener<class_PropertyTweener>`, `SubtweenTweener<class_SubtweenTweener>`
