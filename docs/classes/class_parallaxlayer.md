...
- `void (No return value.)` **set_mirroring**(value: `Vector2<class_Vector2>`)
...
- `void (No return value.)` **set_motion_offset**(value: `Vector2<class_Vector2>`)
...
- `void (No return value.)` **set_motion_scale**(value: `Vector2<class_Vector2>`)
