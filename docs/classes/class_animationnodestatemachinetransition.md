...
- `void (No return value.)` **set_advance_condition**(value: `StringName<class_StringName>`)
...
- `void (No return value.)` **set_advance_expression**(value: `String<class_String>`)
...
- `void (No return value.)` **set_advance_mode**(value: `AdvanceMode<enum_AnimationNodeStateMachineTransition_AdvanceMode>`)
...
- `void (No return value.)` **set_reset**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_switch_mode**(value: `SwitchMode<enum_AnimationNodeStateMachineTransition_SwitchMode>`)
