...
`Operator<enum_VisualShaderNodeUIntOp_Operator>` **operator** = `0` `🔗<class_VisualShaderNodeUIntOp_property_operator>`

classref-property-setget

- `void (No return value.)` **set_operator**(value: `Operator<enum_VisualShaderNodeUIntOp_Operator>`)
