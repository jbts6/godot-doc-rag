...
`void (No return value.)` **register_interaction_profile**(display_name: `String<class_String>`, openxr_path: `String<class_String>`, openxr_extension_names: `String<class_String>`) `🔗<class_OpenXRInteractionProfileMetadata_method_register_interaction_profile>`
...
`void (No return value.)` **register_path_rename**(old_name: `String<class_String>`, new_name: `String<class_String>`) `🔗<class_OpenXRInteractionProfileMetadata_method_register_path_rename>`
...
`void (No return value.)` **register_profile_rename**(old_name: `String<class_String>`, new_name: `String<class_String>`) `🔗<class_OpenXRInteractionProfileMetadata_method_register_profile_rename>`
...
`void (No return value.)` **register_top_level_path**(display_name: `String<class_String>`, openxr_path: `String<class_String>`, openxr_extension_names: `String<class_String>`) `🔗<class_OpenXRInteractionProfileMetadata_method_register_top_level_path>`
