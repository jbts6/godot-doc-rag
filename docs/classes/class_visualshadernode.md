...
- `void (No return value.)` **set_output_port_for_preview**(value: `int<class_int>`)
...
`void (No return value.)` **clear_default_input_values**() `🔗<class_VisualShaderNode_method_clear_default_input_values>`
...
`int<class_int>` **get_default_input_port**(type: `PortType<enum_VisualShaderNode_PortType>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_VisualShaderNode_method_get_default_input_port>`
...
`Array<class_Array>` **get_default_input_values**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_VisualShaderNode_method_get_default_input_values>`
...
`Variant<class_Variant>` **get_input_port_default_value**(port: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_VisualShaderNode_method_get_input_port_default_value>`
...
`void (No return value.)` **remove_input_port_default_value**(port: `int<class_int>`) `🔗<class_VisualShaderNode_method_remove_input_port_default_value>`
...
`void (No return value.)` **set_default_input_values**(values: `Array<class_Array>`) `🔗<class_VisualShaderNode_method_set_default_input_values>`
...
`void (No return value.)` **set_input_port_default_value**(port: `int<class_int>`, value: `Variant<class_Variant>`, prev_value: `Variant<class_Variant>` = null) `🔗<class_VisualShaderNode_method_set_input_port_default_value>`
