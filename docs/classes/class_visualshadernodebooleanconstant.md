...
`bool<class_bool>` **constant** = `false` `🔗<class_VisualShaderNodeBooleanConstant_property_constant>`

classref-property-setget

- `void (No return value.)` **set_constant**(value: `bool<class_bool>`)
- `bool<class_bool>` **get_constant**()
