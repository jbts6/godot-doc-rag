...
- `void (No return value.)` **set_bake_fps**(value: `float<class_float>`)
...
- `void (No return value.)` **set_base_path**(value: `String<class_String>`)
...
- `void (No return value.)` **set_buffers**(value: `Array<class_Array>`\[`PackedByteArray<class_PackedByteArray>`\])
...
- `void (No return value.)` **set_copyright**(value: `String<class_String>`)
...
- `void (No return value.)` **set_create_animations**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_filename**(value: `String<class_String>`)
...
- `void (No return value.)` **set_glb_data**(value: `PackedByteArray<class_PackedByteArray>`)
...
- `void (No return value.)` **set_handle_binary_image_mode**(value: `HandleBinaryImageMode<enum_GLTFState_HandleBinaryImageMode>`)
...
- `void (No return value.)` **set_import_as_skeleton_bones**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_json**(value: `Dictionary<class_Dictionary>`)
...
- `void (No return value.)` **set_major_version**(value: `int<class_int>`)
...
- `void (No return value.)` **set_minor_version**(value: `int<class_int>`)
...
- `void (No return value.)` **set_root_nodes**(value: `PackedInt32Array<class_PackedInt32Array>`)
...
- `void (No return value.)` **set_scene_name**(value: `String<class_String>`)
...
- `void (No return value.)` **set_use_named_skin_binds**(value: `bool<class_bool>`)
...
`void (No return value.)` **add_used_extension**(extension_name: `String<class_String>`, required: `bool<class_bool>`) `🔗<class_GLTFState_method_add_used_extension>`
...
`Array<class_Array>`\[`GLTFAccessor<class_GLTFAccessor>`\] **get_accessors**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_accessors>`
...
`Variant<class_Variant>` **get_additional_data**(extension_name: `StringName<class_StringName>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_additional_data>`
...
`AnimationPlayer<class_AnimationPlayer>` **get_animation_player**(anim_player_index: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_animation_player>`
...
`int<class_int>` **get_animation_players_count**(anim_player_index: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_animation_players_count>`
...
`Array<class_Array>`\[`GLTFAnimation<class_GLTFAnimation>`\] **get_animations**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_animations>`
...
`Array<class_Array>`\[`GLTFBufferView<class_GLTFBufferView>`\] **get_buffer_views**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_buffer_views>`
...
`Array<class_Array>`\[`GLTFCamera<class_GLTFCamera>`\] **get_cameras**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_cameras>`
...
`int<class_int>` **get_handle_binary_image**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_handle_binary_image>`
...
`Array<class_Array>`\[`Texture2D<class_Texture2D>`\] **get_images**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_images>`
...
`Array<class_Array>`\[`GLTFLight<class_GLTFLight>`\] **get_lights**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_lights>`
...
`Array<class_Array>`\[`Material<class_Material>`\] **get_materials**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_materials>`
...
`Array<class_Array>`\[`GLTFMesh<class_GLTFMesh>`\] **get_meshes**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_meshes>`
...
`int<class_int>` **get_node_index**(scene_node: `Node<class_Node>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_node_index>`
...
`Array<class_Array>`\[`GLTFNode<class_GLTFNode>`\] **get_nodes**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_nodes>`
...
`Node<class_Node>` **get_scene_node**(gltf_node_index: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_scene_node>`
...
`Array<class_Array>`\[`GLTFSkeleton<class_GLTFSkeleton>`\] **get_skeletons**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_skeletons>`
...
`Array<class_Array>`\[`GLTFSkin<class_GLTFSkin>`\] **get_skins**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_skins>`
...
`Array<class_Array>`\[`GLTFTextureSampler<class_GLTFTextureSampler>`\] **get_texture_samplers**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_texture_samplers>`
...
`Array<class_Array>`\[`GLTFTexture<class_GLTFTexture>`\] **get_textures**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_textures>`
...
`Array<class_Array>`\[`String<class_String>`\] **get_unique_animation_names**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_unique_animation_names>`
...
`Array<class_Array>`\[`String<class_String>`\] **get_unique_names**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_GLTFState_method_get_unique_names>`
...
`void (No return value.)` **set_accessors**(accessors: `Array<class_Array>`\[`GLTFAccessor<class_GLTFAccessor>`\]) `🔗<class_GLTFState_method_set_accessors>`
...
`void (No return value.)` **set_additional_data**(extension_name: `StringName<class_StringName>`, additional_data: `Variant<class_Variant>`) `🔗<class_GLTFState_method_set_additional_data>`
...
`void (No return value.)` **set_animations**(animations: `Array<class_Array>`\[`GLTFAnimation<class_GLTFAnimation>`\]) `🔗<class_GLTFState_method_set_animations>`
...
`void (No return value.)` **set_buffer_views**(buffer_views: `Array<class_Array>`\[`GLTFBufferView<class_GLTFBufferView>`\]) `🔗<class_GLTFState_method_set_buffer_views>`
...
`void (No return value.)` **set_cameras**(cameras: `Array<class_Array>`\[`GLTFCamera<class_GLTFCamera>`\]) `🔗<class_GLTFState_method_set_cameras>`
...
`void (No return value.)` **set_handle_binary_image**(method: `int<class_int>`) `🔗<class_GLTFState_method_set_handle_binary_image>`
...
`void (No return value.)` **set_images**(images: `Array<class_Array>`\[`Texture2D<class_Texture2D>`\]) `🔗<class_GLTFState_method_set_images>`
...
`void (No return value.)` **set_lights**(lights: `Array<class_Array>`\[`GLTFLight<class_GLTFLight>`\]) `🔗<class_GLTFState_method_set_lights>`
...
`void (No return value.)` **set_materials**(materials: `Array<class_Array>`\[`Material<class_Material>`\]) `🔗<class_GLTFState_method_set_materials>`
...
`void (No return value.)` **set_meshes**(meshes: `Array<class_Array>`\[`GLTFMesh<class_GLTFMesh>`\]) `🔗<class_GLTFState_method_set_meshes>`
...
`void (No return value.)` **set_nodes**(nodes: `Array<class_Array>`\[`GLTFNode<class_GLTFNode>`\]) `🔗<class_GLTFState_method_set_nodes>`
...
`void (No return value.)` **set_skeletons**(skeletons: `Array<class_Array>`\[`GLTFSkeleton<class_GLTFSkeleton>`\]) `🔗<class_GLTFState_method_set_skeletons>`
...
`void (No return value.)` **set_skins**(skins: `Array<class_Array>`\[`GLTFSkin<class_GLTFSkin>`\]) `🔗<class_GLTFState_method_set_skins>`
...
`void (No return value.)` **set_texture_samplers**(texture_samplers: `Array<class_Array>`\[`GLTFTextureSampler<class_GLTFTextureSampler>`\]) `🔗<class_GLTFState_method_set_texture_samplers>`
...
`void (No return value.)` **set_textures**(textures: `Array<class_Array>`\[`GLTFTexture<class_GLTFTexture>`\]) `🔗<class_GLTFState_method_set_textures>`
...
`void (No return value.)` **set_unique_animation_names**(unique_animation_names: `Array<class_Array>`\[`String<class_String>`\]) `🔗<class_GLTFState_method_set_unique_animation_names>`
...
`void (No return value.)` **set_unique_names**(unique_names: `Array<class_Array>`\[`String<class_String>`\]) `🔗<class_GLTFState_method_set_unique_names>`
