...
`void (No return value.)` **append_array**(array: `PackedStringArray<class_PackedStringArray>`) `🔗<class_PackedStringArray_method_append_array>`
...
`int<class_int>` **bsearch**(value: `String<class_String>`, before: `bool<class_bool>` = true) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_bsearch>`
...
`void (No return value.)` **clear**() `🔗<class_PackedStringArray_method_clear>`
...
`int<class_int>` **count**(value: `String<class_String>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_count>`
...
`PackedStringArray<class_PackedStringArray>` **duplicate**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_duplicate>`
...
`void (No return value.)` **fill**(value: `String<class_String>`) `🔗<class_PackedStringArray_method_fill>`
...
`int<class_int>` **find**(value: `String<class_String>`, from: `int<class_int>` = 0) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_find>`
...
`String<class_String>` **get**(index: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_get>`
...
`bool<class_bool>` **has**(value: `String<class_String>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_has>`
...
`bool<class_bool>` **is_empty**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_is_empty>`
...
`void (No return value.)` **remove_at**(index: `int<class_int>`) `🔗<class_PackedStringArray_method_remove_at>`
...
`void (No return value.)` **reverse**() `🔗<class_PackedStringArray_method_reverse>`
...
`int<class_int>` **rfind**(value: `String<class_String>`, from: `int<class_int>` = -1) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_rfind>`
...
`void (No return value.)` **set**(index: `int<class_int>`, value: `String<class_String>`) `🔗<class_PackedStringArray_method_set>`
...
`int<class_int>` **size**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_size>`
...
`PackedStringArray<class_PackedStringArray>` **slice**(begin: `int<class_int>`, end: `int<class_int>` = 2147483647) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_slice>`
...
`void (No return value.)` **sort**() `🔗<class_PackedStringArray_method_sort>`
...
`PackedByteArray<class_PackedByteArray>` **to_byte_array**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_PackedStringArray_method_to_byte_array>`
