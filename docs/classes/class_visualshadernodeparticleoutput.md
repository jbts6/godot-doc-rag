...
**Inherits:** `VisualShaderNodeOutput<class_VisualShaderNodeOutput>` **\<** `VisualShaderNode<class_VisualShaderNode>` **\<** `Resource<class_Resource>` **\<** `RefCounted<class_RefCounted>` **\<** `Object<class_Object>`
