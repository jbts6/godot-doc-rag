...
`bool<class_bool>` **array_mesh/deduplicate_surfaces** = `true` `🔗<class_ResourceImporterScene_property_array_mesh/deduplicate_surfaces>`
...
`bool<class_bool>` **mesh_library/use_node_names_as_mesh_names** = `false` `🔗<class_ResourceImporterScene_property_mesh_library/use_node_names_as_mesh_names>`
