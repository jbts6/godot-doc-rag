...
> [!NOTE]
> When testing different stretch modes and stretch aspect settings, make sure `game embedding <doc_game_embedding>` is configured to use the `Stretch to Fit` scaling option:
>
>
> <img src="img/multiple_resolutions_game_embedding_size_dropdown.webp" />
>
>
