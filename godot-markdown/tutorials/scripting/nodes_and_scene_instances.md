...
private Sprite2D sprite2D; private Camera2D camera2D;

public override void Ready() { base.\_Ready();

> sprite2D = GetNode\<Sprite2D\>("Sprite2D"); camera2D = GetNode\<Camera2D\>("Camera2D");
...
> animationPlayer = GetNode\<AnimationPlayer\>("ShieldBar/AnimationPlayer");
...
> sprite2D = new Sprite2D(); // Create a new Sprite2D. AddChild(sprite2D); // Add it as a child of this node.
