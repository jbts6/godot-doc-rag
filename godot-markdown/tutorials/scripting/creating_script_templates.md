...
\# Called when the node enters the scene tree for the first time. func ready() -\> void: pass \# Replace with function body.

\# Called every frame. 'delta' is the elapsed time since the previous frame. func process(delta: float) -\> void: pass

csharp

// meta-description: Base template for Node with default Godot cycle methods

using BINDINGS_NAMESPACE\_; using System;

public partial class CLASS\_ : BASE\_ { // Called when the node enters the scene tree for the first time. public override void Ready() { }

> // Called every frame. 'delta' is the elapsed time since the previous frame. public override void Process(double delta) { }
