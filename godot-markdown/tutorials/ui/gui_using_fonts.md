...
Changing import type to <strong>Font Data (Image Font)</strong>
...
Credit: <a href="https://github.com/MissLav/LibreQuake/blob/master/lq1/gfx-wad/CONCHARS.png">LibreQuake</a> (scaled and cropped to exclude extended range)
...
Enabling prerendering in the Advanced Import Settings dialog with the <strong>Glyphs from the Translations</strong> tab
...
Enabling prerendering in the Advanced Import Settings dialog with the <strong>Glyphs from the Text</strong> tab
...
Enabling prerendering in the Advanced Import Settings dialog with the <strong>Glyphs from the Character Map</strong> tab
