...
Example of using glow in a 2D scene. HDR 2D is enabled, while coins and the bullet have their <strong>Modulate</strong> property increased to overbright values using the Intensity slider in the color picker.
