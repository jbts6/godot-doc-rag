...
Creating a PO template in the <code class="interpreted-text" role="menu">Localization &gt; Template Generation</code> tab of the <code class="interpreted-text" role="ui">Project Settings</code>
