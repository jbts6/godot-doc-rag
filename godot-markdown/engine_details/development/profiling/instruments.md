...
Please see the `sampling profiler instructions <doc_sampling_profilers>` and the `tracing profiler instructions <doc_tracing_profilers>` for more information.

- Open [Xcode](https://developer.apple.com/xcode/). Select **Open Developer Tool** - **Instruments** from the **Xcode** app menu:
...
- Select **Hide system libraries** in the **Call Tree** menu (at the bottom of the window) to remove external modules.
