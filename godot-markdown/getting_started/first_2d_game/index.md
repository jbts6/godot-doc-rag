...
> [!NOTE]
> This project is an introduction to the Godot engine. It assumes that you have some programming experience already. If you're new to programming entirely, you should start here: `doc_scripting`.
...
This step-by-step tutorial is intended for beginners who followed the complete `doc_step_by_step`.

If you're an experienced programmer, you can find the complete demo's source code here: [Dodge the Creeps source code](https://github.com/godotengine/godot-demo-projects/tree/master/2d/dodge_the_creeps).
...
01.project_setup 02.player_scene 03.coding_the_player 04.creating_the_enemy 05.the_main_game_scene 06.heads_up_display 07.finishing-up