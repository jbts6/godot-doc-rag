...
- `void (No return value.)` **set_ignore_texture_size**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_stretch_mode**(value: `StretchMode<enum_TextureButton_StretchMode>`)
...
- `void (No return value.)` **set_click_mask**(value: `BitMap<class_BitMap>`)
...
- `void (No return value.)` **set_texture_disabled**(value: `Texture2D<class_Texture2D>`)
...
- `void (No return value.)` **set_texture_focused**(value: `Texture2D<class_Texture2D>`)
...
- `void (No return value.)` **set_texture_hover**(value: `Texture2D<class_Texture2D>`)
