...
`void (No return value.)` **bake**(navigation_mesh: `NavigationMesh<class_NavigationMesh>`, root_node: `Node<class_Node>`) `🔗<class_NavigationMeshGenerator_method_bake>`
...
`void (No return value.)` **clear**(navigation_mesh: `NavigationMesh<class_NavigationMesh>`) `🔗<class_NavigationMeshGenerator_method_clear>`
