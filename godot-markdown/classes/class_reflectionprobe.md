...
- `void (No return value.)` **set_ambient_color**(value: `Color<class_Color>`)
...
- `void (No return value.)` **set_ambient_color_energy**(value: `float<class_float>`)
...
- `void (No return value.)` **set_ambient_mode**(value: `AmbientMode<enum_ReflectionProbe_AmbientMode>`)
...
- `void (No return value.)` **set_blend_distance**(value: `float<class_float>`)
...
- `void (No return value.)` **set_enable_box_projection**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_enable_shadows**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_as_interior**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_reflection_mask**(value: `int<class_int>`)
...
- `void (No return value.)` **set_update_mode**(value: `UpdateMode<enum_ReflectionProbe_UpdateMode>`)
