...
- `void (No return value.)` **set_motion_mode**(value: `MotionMode<enum_CharacterBody3D_MotionMode>`)
...
- `void (No return value.)` **set_platform_on_leave**(value: `PlatformOnLeave<enum_CharacterBody3D_PlatformOnLeave>`)
...
- `void (No return value.)` **set_up_direction**(value: `Vector3<class_Vector3>`)
...
`void (No return value.)` **apply_floor_snap**() `🔗<class_CharacterBody3D_method_apply_floor_snap>`
...
`float<class_float>` **get_floor_angle**(up_direction: `Vector3<class_Vector3>` = Vector3(0, 1, 0)) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_floor_angle>`
...
`Vector3<class_Vector3>` **get_floor_normal**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_floor_normal>`
...
`Vector3<class_Vector3>` **get_last_motion**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_last_motion>`
...
`Vector3<class_Vector3>` **get_platform_angular_velocity**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_platform_angular_velocity>`
...
`Vector3<class_Vector3>` **get_platform_velocity**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_platform_velocity>`
...
`Vector3<class_Vector3>` **get_position_delta**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_position_delta>`
...
`Vector3<class_Vector3>` **get_real_velocity**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_real_velocity>`
...
`int<class_int>` **get_slide_collision_count**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_slide_collision_count>`
...
`Vector3<class_Vector3>` **get_wall_normal**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_get_wall_normal>`
...
`bool<class_bool>` **is_on_ceiling**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_is_on_ceiling>`
...
`bool<class_bool>` **is_on_ceiling_only**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_is_on_ceiling_only>`
...
`bool<class_bool>` **is_on_floor**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_is_on_floor>`
...
`bool<class_bool>` **is_on_floor_only**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_is_on_floor_only>`
...
`bool<class_bool>` **is_on_wall**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_is_on_wall>`
...
`bool<class_bool>` **is_on_wall_only**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_CharacterBody3D_method_is_on_wall_only>`
