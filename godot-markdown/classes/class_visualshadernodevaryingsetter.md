...
**Inherits:** `VisualShaderNodeVarying<class_VisualShaderNodeVarying>` **\<** `VisualShaderNode<class_VisualShaderNode>` **\<** `Resource<class_Resource>` **\<** `RefCounted<class_RefCounted>` **\<** `Object<class_Object>`
