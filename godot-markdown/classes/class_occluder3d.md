...
`PackedInt32Array<class_PackedInt32Array>` **get_indices**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Occluder3D_method_get_indices>`
...
`PackedVector3Array<class_PackedVector3Array>` **get_vertices**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_Occluder3D_method_get_vertices>`
