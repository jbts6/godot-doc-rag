...
- `void (No return value.)` **set_indices**(value: `PackedInt32Array<class_PackedInt32Array>`)
...
`void (No return value.)` **set_arrays**(vertices: `PackedVector3Array<class_PackedVector3Array>`, indices: `PackedInt32Array<class_PackedInt32Array>`) `🔗<class_ArrayOccluder3D_method_set_arrays>`
