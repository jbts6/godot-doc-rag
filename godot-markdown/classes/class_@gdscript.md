...
**@export_custom**(hint: `PropertyHint<enum_@GlobalScope_PropertyHint>`, hint_string: `String<class_String>`, usage: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`PropertyUsageFlags<enum_@GlobalScope_PropertyUsageFlags>`\] = 6) `🔗<class_@GDScript_annotation_@export_custom>`
...
**@export_enum**(names: `String<class_String>`, ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_enum>`
...
**@export_exp_easing**(hints: `String<class_String>` = "", ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_exp_easing>`
...
**@export_file**(filter: `String<class_String>` = "", ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_file>`
...
**@export_file_path**(filter: `String<class_String>` = "", ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_file_path>`
...
**@export_flags**(names: `String<class_String>`, ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_flags>`
...
**@export_global_file**(filter: `String<class_String>` = "", ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_global_file>`
...
**@export_multiline**(hint: `String<class_String>` = "", ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_multiline>`
...
**@export_node_path**(type: `String<class_String>` = "", ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_node_path>`
...
**@export_range**(min: `float<class_float>`, max: `float<class_float>`, step: `float<class_float>` = 1.0, extra_hints: `String<class_String>` = "", ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@export_range>`
...
**@warning_ignore**(warning: `String<class_String>`, ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@warning_ignore>`
...
**@warning_ignore_restore**(warning: `String<class_String>`, ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@warning_ignore_restore>`
...
**@warning_ignore_start**(warning: `String<class_String>`, ...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_annotation_@warning_ignore_start>`
...
`void (No return value.)` **assert**(condition: `bool<class_bool>`, message: `String<class_String>` = "") `🔗<class_@GDScript_method_assert>`

Asserts that the `condition` is `true`. If the `condition` is `false`, an error is generated and the current method returns a default value. When running from the editor, failed asserts also cause a debugger break. This can be used as a stronger form of `@GlobalScope.push_error()<class_@GlobalScope_method_push_error>` for reporting errors to project developers or add-on users.
...
See also `@GlobalScope.typeof()<class_@GlobalScope_method_typeof>`, `Object.is_class()<class_Object_method_is_class>`, `Object.get_script()<class_Object_method_get_script>`, `Array.is_same_typed()<class_Array_method_is_same_typed>` (and other `Array<class_Array>` methods), `Dictionary.is_same_typed()<class_Dictionary_method_is_same_typed>` (and other `Dictionary<class_Dictionary>` methods).
...
`void (No return value.)` **print_debug**(...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_method_print_debug>`
...
`void (No return value.)` **print_stack**() `🔗<class_@GDScript_method_print_stack>`
...
`Array<class_Array>` **range**(...) `vararg (This method accepts any number of arguments after the ones described here.)` `🔗<class_@GDScript_method_range>`
...
**Deprecated:** Use `ClassDB.class_exists()<class_ClassDB_method_class_exists>` instead.
