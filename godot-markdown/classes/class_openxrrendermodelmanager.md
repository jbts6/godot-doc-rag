...
- `void (No return value.)` **set_make_local_to_pose**(value: `String<class_String>`)
...
- `void (No return value.)` **set_tracker**(value: `RenderModelTracker<enum_OpenXRRenderModelManager_RenderModelTracker>`)
