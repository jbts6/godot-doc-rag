...
- `void (No return value.)` **set_blend_mode**(value: `BlendMode<enum_CanvasItemMaterial_BlendMode>`)
...
- `void (No return value.)` **set_light_mode**(value: `LightMode<enum_CanvasItemMaterial_LightMode>`)
...
- `void (No return value.)` **set_particles_animation**(value: `bool<class_bool>`)
