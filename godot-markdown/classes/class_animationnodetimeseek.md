...
\# Play child animation from the start. animation_tree.set("parameters/TimeSeek/seek_request", 0.0) \# Alternative syntax (same result as above). animation_tree\["parameters/TimeSeek/seek_request"\] = 0.0

\# Play child animation from 12 second timestamp. animation_tree.set("parameters/TimeSeek/seek_request", 12.0) \# Alternative syntax (same result as above). animation_tree\["parameters/TimeSeek/seek_request"\] = 12.0
...
- `void (No return value.)` **set_explicit_elapse**(value: `bool<class_bool>`)
