...
`Error<enum_@GlobalScope_Error>` **add_file_from_buffer**(target_path: `String<class_String>`, data: `PackedByteArray<class_PackedByteArray>`, encrypt: `bool<class_bool>` = false) `🔗<class_PCKPacker_method_add_file_from_buffer>`
