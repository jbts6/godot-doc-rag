...
`String<class_String>` **get_instance_path**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_InstancePlaceholder_method_get_instance_path>`
