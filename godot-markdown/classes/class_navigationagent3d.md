...
- `void (No return value.)` **set_keep_y_velocity**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_path_height_offset**(value: `float<class_float>`)
...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`PathMetadataFlags<enum_NavigationPathQueryParameters3D_PathMetadataFlags>`\] **path_metadata_flags** = `7` `🔗<class_NavigationAgent3D_property_path_metadata_flags>`

classref-property-setget

- `void (No return value.)` **set_path_metadata_flags**(value: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`PathMetadataFlags<enum_NavigationPathQueryParameters3D_PathMetadataFlags>`\])
- `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`PathMetadataFlags<enum_NavigationPathQueryParameters3D_PathMetadataFlags>`\] **get_path_metadata_flags**()
...
- `void (No return value.)` **set_use_3d_avoidance**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_velocity**(value: `Vector3<class_Vector3>`)
...
`float<class_float>` **distance_to_target**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_distance_to_target>`
...
`bool<class_bool>` **get_avoidance_layer_value**(layer_number: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_avoidance_layer_value>`
...
`bool<class_bool>` **get_avoidance_mask_value**(mask_number: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_avoidance_mask_value>`
...
`PackedVector3Array<class_PackedVector3Array>` **get_current_navigation_path**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_current_navigation_path>`
...
`int<class_int>` **get_current_navigation_path_index**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_current_navigation_path_index>`
...
`NavigationPathQueryResult3D<class_NavigationPathQueryResult3D>` **get_current_navigation_result**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_current_navigation_result>`
...
`bool<class_bool>` **get_navigation_layer_value**(layer_number: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_navigation_layer_value>`
...
`RID<class_RID>` **get_navigation_map**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_navigation_map>`
...
`float<class_float>` **get_path_length**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_path_length>`
...
`RID<class_RID>` **get_rid**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_get_rid>`
...
`bool<class_bool>` **is_target_reached**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_NavigationAgent3D_method_is_target_reached>`
...
`void (No return value.)` **set_avoidance_layer_value**(layer_number: `int<class_int>`, value: `bool<class_bool>`) `🔗<class_NavigationAgent3D_method_set_avoidance_layer_value>`
...
`void (No return value.)` **set_avoidance_mask_value**(mask_number: `int<class_int>`, value: `bool<class_bool>`) `🔗<class_NavigationAgent3D_method_set_avoidance_mask_value>`
...
`void (No return value.)` **set_navigation_layer_value**(layer_number: `int<class_int>`, value: `bool<class_bool>`) `🔗<class_NavigationAgent3D_method_set_navigation_layer_value>`
...
`void (No return value.)` **set_navigation_map**(navigation_map: `RID<class_RID>`) `🔗<class_NavigationAgent3D_method_set_navigation_map>`
...
`void (No return value.)` **set_velocity_forced**(velocity: `Vector3<class_Vector3>`) `🔗<class_NavigationAgent3D_method_set_velocity_forced>`
