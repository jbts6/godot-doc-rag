...
- `Making plugins <../tutorials/plugins/editor/making_plugins>`
...
**opened**() `🔗<class_EditorDock_signal_opened>`
...
`DockSlot<enum_EditorDock_DockSlot>` **DOCK_SLOT_BOTTOM_L** = `9`

Dock slot at the bottom, below bottom panel, on the left side.

classref-enumeration-constant

`DockSlot<enum_EditorDock_DockSlot>` **DOCK_SLOT_BOTTOM_R** = `10`

Dock slot at the bottom, below bottom panel, on the right side.

classref-enumeration-constant

`DockSlot<enum_EditorDock_DockSlot>` **DOCK_SLOT_MAX** = `11`
...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`DockLayout<enum_EditorDock_DockLayout>`\] **available_layouts** = `5` `🔗<class_EditorDock_property_available_layouts>`

classref-property-setget

- `void (No return value.)` **set_available_layouts**(value: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`DockLayout<enum_EditorDock_DockLayout>`\])
- `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`DockLayout<enum_EditorDock_DockLayout>`\] **get_available_layouts**()
...
- `void (No return value.)` **set_closable**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_default_slot**(value: `DockSlot<enum_EditorDock_DockSlot>`)
...
- `void (No return value.)` **set_dock_icon**(value: `Texture2D<class_Texture2D>`)
...
- `void (No return value.)` **set_dock_shortcut**(value: `Shortcut<class_Shortcut>`)
...
- `void (No return value.)` **set_force_show_icon**(value: `bool<class_bool>`)
- `bool<class_bool>` **get_force_show_icon**()

If `true`, the dock will always display an icon, regardless of `EditorSettings.interface/editor/docks/dock_tab_style<class_EditorSettings_property_interface/editor/docks/dock_tab_style>` or `EditorSettings.interface/editor/docks/bottom_dock_tab_style<class_EditorSettings_property_interface/editor/docks/bottom_dock_tab_style>`.
...
- `void (No return value.)` **set_global**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_icon_name**(value: `StringName<class_StringName>`)
...
- `void (No return value.)` **set_layout_key**(value: `String<class_String>`)
...
- `void (No return value.)` **set_title_color**(value: `Color<class_Color>`)
...
`void (No return value.)` **\_load_layout_from_config**(config: `ConfigFile<class_ConfigFile>`, section: `String<class_String>`) `virtual (This method should typically be overridden by the user to have any effect.)` `🔗<class_EditorDock_private_method__load_layout_from_config>`
...
`void (No return value.)` **\_save_layout_to_config**(config: `ConfigFile<class_ConfigFile>`, section: `String<class_String>`) `virtual (This method should typically be overridden by the user to have any effect.)` `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_EditorDock_private_method__save_layout_to_config>`
...
`void (No return value.)` **\_update_layout**(layout: `int<class_int>`) `virtual (This method should typically be overridden by the user to have any effect.)` `🔗<class_EditorDock_private_method__update_layout>`
...
`void (No return value.)` **close**() `🔗<class_EditorDock_method_close>`
...
`void (No return value.)` **make_visible**() `🔗<class_EditorDock_method_make_visible>`
...
`void (No return value.)` **open**() `🔗<class_EditorDock_method_open>`
