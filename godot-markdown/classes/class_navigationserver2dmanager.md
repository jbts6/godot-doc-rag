...
`void (No return value.)` **register_server**(name: `String<class_String>`, create_callback: `Callable<class_Callable>`) `🔗<class_NavigationServer2DManager_method_register_server>`
...
`void (No return value.)` **set_default_server**(name: `String<class_String>`, priority: `int<class_int>`) `🔗<class_NavigationServer2DManager_method_set_default_server>`
