...
**user_presence_changed**(is_user_present: `bool<class_bool>`) `🔗<class_OpenXRInterface_signal_user_presence_changed>`
...
- `void (No return value.)` **set_display_refresh_rate**(value: `float<class_float>`)
...
- `void (No return value.)` **set_foveation_dynamic**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_foveation_level**(value: `int<class_int>`)
...
`bool<class_bool>` **foveation_with_subsampled_images** = `false` `🔗<class_OpenXRInterface_property_foveation_with_subsampled_images>`

classref-property-setget

- `void (No return value.)` **set_foveation_with_subsampled_images**(value: `bool<class_bool>`)
- `bool<class_bool>` **get_foveation_with_subsampled_images**()
...
- `void (No return value.)` **set_render_target_size_multiplier**(value: `float<class_float>`)
...
`Array<class_Array>` **get_action_sets**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_action_sets>`
...
`Array<class_Array>` **get_available_display_refresh_rates**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_available_display_refresh_rates>`
...
`Vector3<class_Vector3>` **get_hand_joint_angular_velocity**(hand: `Hand<enum_OpenXRInterface_Hand>`, joint: `HandJoints<enum_OpenXRInterface_HandJoints>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_hand_joint_angular_velocity>`
...
`Vector3<class_Vector3>` **get_hand_joint_linear_velocity**(hand: `Hand<enum_OpenXRInterface_Hand>`, joint: `HandJoints<enum_OpenXRInterface_HandJoints>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_hand_joint_linear_velocity>`
...
`Vector3<class_Vector3>` **get_hand_joint_position**(hand: `Hand<enum_OpenXRInterface_Hand>`, joint: `HandJoints<enum_OpenXRInterface_HandJoints>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_hand_joint_position>`
...
`float<class_float>` **get_hand_joint_radius**(hand: `Hand<enum_OpenXRInterface_Hand>`, joint: `HandJoints<enum_OpenXRInterface_HandJoints>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_hand_joint_radius>`
...
`Quaternion<class_Quaternion>` **get_hand_joint_rotation**(hand: `Hand<enum_OpenXRInterface_Hand>`, joint: `HandJoints<enum_OpenXRInterface_HandJoints>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_hand_joint_rotation>`
...
`HandTrackedSource<enum_OpenXRInterface_HandTrackedSource>` **get_hand_tracking_source**(hand: `Hand<enum_OpenXRInterface_Hand>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_hand_tracking_source>`
...
`HandMotionRange<enum_OpenXRInterface_HandMotionRange>` **get_motion_range**(hand: `Hand<enum_OpenXRInterface_Hand>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_get_motion_range>`
...
`bool<class_bool>` **is_action_set_active**(name: `String<class_String>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_is_action_set_active>`
...
`bool<class_bool>` **is_foveation_supported**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_is_foveation_supported>`
...
`bool<class_bool>` **is_hand_interaction_supported**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_is_hand_interaction_supported>`
...
`bool<class_bool>` **is_user_presence_supported**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_is_user_presence_supported>`
...
`bool<class_bool>` **is_user_present**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_OpenXRInterface_method_is_user_present>`
...
`void (No return value.)` **set_action_set_active**(name: `String<class_String>`, active: `bool<class_bool>`) `🔗<class_OpenXRInterface_method_set_action_set_active>`
...
`void (No return value.)` **set_cpu_level**(level: `PerfSettingsLevel<enum_OpenXRInterface_PerfSettingsLevel>`) `🔗<class_OpenXRInterface_method_set_cpu_level>`
...
`void (No return value.)` **set_gpu_level**(level: `PerfSettingsLevel<enum_OpenXRInterface_PerfSettingsLevel>`) `🔗<class_OpenXRInterface_method_set_gpu_level>`
...
`void (No return value.)` **set_motion_range**(hand: `Hand<enum_OpenXRInterface_Hand>`, motion_range: `HandMotionRange<enum_OpenXRInterface_HandMotionRange>`) `🔗<class_OpenXRInterface_method_set_motion_range>`
