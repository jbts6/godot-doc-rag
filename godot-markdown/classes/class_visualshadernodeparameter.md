...
- `void (No return value.)` **set_instance_index**(value: `int<class_int>`)
...
- `void (No return value.)` **set_qualifier**(value: `Qualifier<enum_VisualShaderNodeParameter_Qualifier>`)
