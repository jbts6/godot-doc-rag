...
- `void (No return value.)` **set_enable_alpha_to_coverage**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_enable_alpha_to_one**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_enable_sample_shading**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_min_sample_shading**(value: `float<class_float>`)
...
- `void (No return value.)` **set_sample_count**(value: `TextureSamples<enum_RenderingDevice_TextureSamples>`)
...
- `void (No return value.)` **set_sample_masks**(value: `Array<class_Array>`\[`int<class_int>`\])
