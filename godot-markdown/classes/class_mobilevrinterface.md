...
- `void (No return value.)` **set_display_to_lens**(value: `float<class_float>`)
...
- `void (No return value.)` **set_display_width**(value: `float<class_float>`)
...
- `void (No return value.)` **set_eye_height**(value: `float<class_float>`)
...
- `void (No return value.)` **set_iod**(value: `float<class_float>`)
...
- `void (No return value.)` **set_k1**(value: `float<class_float>`)
...
- `void (No return value.)` **set_k2**(value: `float<class_float>`)
...
- `void (No return value.)` **set_offset_rect**(value: `Rect2<class_Rect2>`)
...
- `void (No return value.)` **set_oversample**(value: `float<class_float>`)
