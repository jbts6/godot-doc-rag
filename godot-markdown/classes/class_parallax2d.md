...
- `void (No return value.)` **set_autoscroll**(value: `Vector2<class_Vector2>`)
...
- `void (No return value.)` **set_ignore_camera_scroll**(value: `bool<class_bool>`)
...
- `void (No return value.)` **set_repeat_size**(value: `Vector2<class_Vector2>`)
...
- `void (No return value.)` **set_repeat_times**(value: `int<class_int>`)
...
- `void (No return value.)` **set_screen_offset**(value: `Vector2<class_Vector2>`)
...
- `void (No return value.)` **set_scroll_scale**(value: `Vector2<class_Vector2>`)
