...
- `void (No return value.)` **set_diffuse_texture**(value: `Texture2D<class_Texture2D>`)
...
- `void (No return value.)` **set_normal_texture**(value: `Texture2D<class_Texture2D>`)
...
- `void (No return value.)` **set_specular_color**(value: `Color<class_Color>`)
...
- `void (No return value.)` **set_specular_shininess**(value: `float<class_float>`)
...
- `void (No return value.)` **set_specular_texture**(value: `Texture2D<class_Texture2D>`)
