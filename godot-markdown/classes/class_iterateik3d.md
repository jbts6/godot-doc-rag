...
- `void (No return value.)` **set_angular_delta_limit**(value: `float<class_float>`)
...
`JointLimitation3D<class_JointLimitation3D>` **get_joint_limitation**(index: `int<class_int>`, joint: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_IterateIK3D_method_get_joint_limitation>`
...
`SecondaryDirection<enum_SkeletonModifier3D_SecondaryDirection>` **get_joint_limitation_right_axis**(index: `int<class_int>`, joint: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_IterateIK3D_method_get_joint_limitation_right_axis>`
...
`Vector3<class_Vector3>` **get_joint_limitation_right_axis_vector**(index: `int<class_int>`, joint: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_IterateIK3D_method_get_joint_limitation_right_axis_vector>`
...
`Quaternion<class_Quaternion>` **get_joint_limitation_rotation_offset**(index: `int<class_int>`, joint: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_IterateIK3D_method_get_joint_limitation_rotation_offset>`
...
`RotationAxis<enum_SkeletonModifier3D_RotationAxis>` **get_joint_rotation_axis**(index: `int<class_int>`, joint: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_IterateIK3D_method_get_joint_rotation_axis>`
...
`Vector3<class_Vector3>` **get_joint_rotation_axis_vector**(index: `int<class_int>`, joint: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_IterateIK3D_method_get_joint_rotation_axis_vector>`
...
`NodePath<class_NodePath>` **get_target_node**(index: `int<class_int>`) `const (This method has no side effects. It doesn't modify any of the instance's member variables.)` `🔗<class_IterateIK3D_method_get_target_node>`
...
`void (No return value.)` **set_joint_limitation**(index: `int<class_int>`, joint: `int<class_int>`, limitation: `JointLimitation3D<class_JointLimitation3D>`) `🔗<class_IterateIK3D_method_set_joint_limitation>`
...
`void (No return value.)` **set_joint_limitation_right_axis**(index: `int<class_int>`, joint: `int<class_int>`, direction: `SecondaryDirection<enum_SkeletonModifier3D_SecondaryDirection>`) `🔗<class_IterateIK3D_method_set_joint_limitation_right_axis>`
...
`void (No return value.)` **set_joint_limitation_right_axis_vector**(index: `int<class_int>`, joint: `int<class_int>`, vector: `Vector3<class_Vector3>`) `🔗<class_IterateIK3D_method_set_joint_limitation_right_axis_vector>`
...
`void (No return value.)` **set_joint_limitation_rotation_offset**(index: `int<class_int>`, joint: `int<class_int>`, offset: `Quaternion<class_Quaternion>`) `🔗<class_IterateIK3D_method_set_joint_limitation_rotation_offset>`
...
`void (No return value.)` **set_joint_rotation_axis**(index: `int<class_int>`, joint: `int<class_int>`, axis: `RotationAxis<enum_SkeletonModifier3D_RotationAxis>`) `🔗<class_IterateIK3D_method_set_joint_rotation_axis>`
...
`void (No return value.)` **set_joint_rotation_axis_vector**(index: `int<class_int>`, joint: `int<class_int>`, axis_vector: `Vector3<class_Vector3>`) `🔗<class_IterateIK3D_method_set_joint_rotation_axis_vector>`
...
`void (No return value.)` **set_target_node**(index: `int<class_int>`, target_node: `NodePath<class_NodePath>`) `🔗<class_IterateIK3D_method_set_target_node>`
